...
Implemented search by current location using the browser GPS coords. Also, implemented "by_page" with home-made pagination logic (since there is no "next" dataset). 
